const CACHE = "fifa-tournament-hub-v44-2-0-real-game-english";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=44.2.0",
  ...
  "./manager-room.js?v=44.2.0",
  "./manager-match-engine.js?v=44.2.0",
  "./manager-room.css?v=44.2.0",
  "./manager-v42-4.css?v=44.2.0",
  "./manager-v42-5.css?v=44.2.0",
  "./manager-v42-5-levels.css?v=44.2.0",
  "./data/manager-bootstrap-v42.json",
  "./data/manager-team-catalog-fc25.json",
  "./language.js?v=44.2.0",
  "./cloud.js",
  "./chat.js",
  "./community.js",
