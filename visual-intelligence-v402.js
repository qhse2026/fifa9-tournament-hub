(() => {
  ...
  function getBundle() {
    ...
    try {
      ...
      console.warn('[Visual Intelligence V4.0.2] Data adapter skipped:', error);
      return null;
    }
  }
  ...
  function buildDashboard(bundle) {
    ...
    return `
      <div class="vi402-dashboard">
        ${sectionHeader('VISUAL INTELLIGENCE LAB', 'FIFA Universe V4.0 · Güvenli Görsel Katman', 'Mevcut çalışan siteyi değiştirmeden, gerçek uygulama verisini sinematik görsellere çevirir.', 'SAFE CORE 4.0.2')}
