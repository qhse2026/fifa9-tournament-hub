...
-- official Championship OS JSON and the fixed FIFA 10 bracket is advanced.
...
begin
  ...
  if v_both then
    ...
    if v_decided then
      case p_series_id
        when 'F10-PI-1' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-QF-2','awayId',v_winner);
        when 'F10-PI-2' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-QF-4','awayId',v_winner);
        when 'F10-PI-3' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-QF-3','awayId',v_winner);
        when 'F10-PI-4' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-QF-1','awayId',v_winner);
        when 'F10-QF-1' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-SF-1','homeId',v_winner);
        when 'F10-QF-2' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-SF-1','awayId',v_winner);
        when 'F10-QF-3' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-SF-2','homeId',v_winner);
        when 'F10-QF-4' then v_journey:=public._fifa10_set_series_participant(v_journey,'F10-SF-2','awayId',v_winner);
