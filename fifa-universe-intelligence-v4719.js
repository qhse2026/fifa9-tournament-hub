(() => {
  ...
  function renderPlayers(data) {
    ...
    return `<section class="fui-section" data-panel="players">
      ...
      <p class="fui-method">${ui("PPR resmî FPI Rating’in yerine geçmez. Rakip gücü, takımın Bayes-düzeltilmiş performansı, GD/M ve beklenen sonuca göre performansı birleştiren analitik göstergedir. Küçük örneklemler 50 merkezine daraltılır.", "PPR does not replace official FPI Rating. It is an analytical indicator combining opposition strength, Bayesian-adjusted team performance, GD/M and performance versus expectation. Small samples are shrunk toward 50.")}</p>
    </section>`;
  }
