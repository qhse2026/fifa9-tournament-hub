(() => {
  ...
  function renderOverview(career, human, rival, next) {
    ...
    return `${broadcast}<section class="manager-dashboard-grid">
      ...
      <article class="manager-status-panel"><div class="manager-panel-head"><div><span>ENGINE STATUS</span><h3>Single-Source Match Build</h3></div><em>V44.0</em></div><ul><li class="done">Tek pozisyon zinciri: görüntü + karar + veri</li><li class="done">Taktik ve roller fiziksel koşu/pas seçiyor</li><li class="done">UEFA tarzı doğrulanmış istatistik</li><li class="done">×1–×16 deterministik hız</li><li class="done">27 menajer · 9/9/9 lig piramidi</li><li class="done">Oruç Reis yaşayan turnuva ağacı</li></ul></article>
    </section>`;
  }
